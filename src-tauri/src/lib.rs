...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            domains::book_workspace::commands::list_entry_relations,
            domains::book_workspace::commands::list_book_relations,
            domains::book_workspace::commands::create_entry_relation,
            domains::book_workspace::commands::update_entry_relation,
            domains::book_workspace::commands::delete_entry_relation,
            domains::book_workspace::commands::session_fs_exists,
            domains::book_workspace::commands::session_fs_read,
            domains::book_workspace::commands::session_fs_write,
            domains::book_workspace::commands::session_fs_append,
            domains::book_workspace::commands::session_fs_create_dir,
            domains::book_workspace::commands::session_fs_remove,
            domains::book_workspace::commands::session_fs_list_dir,
            ...
            domains::skills::commands::skill_fs_read,
            domains::skills::commands::skill_fs_file_info,
            domains::skills::commands::skill_fs_list_dir,
        ])
