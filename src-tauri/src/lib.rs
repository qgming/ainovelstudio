...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::expansion::list_expansion_prompt_templates,
            workspace::expansion::save_expansion_prompt_template,
            workspace::expansion::reset_expansion_prompt_template,
