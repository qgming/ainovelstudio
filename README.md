...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-0.2.7-111827?style=for-the-badge" alt="Version 0.2.7" />
...
| 平台 | 安装包 |
| --- | --- |
| Windows x64 | [下载 EXE](https://github.com/qgming/ainovelstudio/releases/latest/download/ainovelstudio_0.2.7_windows_x64.exe) |
| Android arm64 | [下载 APK](https://github.com/qgming/ainovelstudio/releases/latest/download/ainovelstudio_0.2.7_android_arm64.apk) |
...
- [v0.2.7](docs/releases/v0.2.7.md)：镜像文件自动同步回内部工作区、桌面端关闭即退出、托盘轻量模式与 AI 状态展示。
