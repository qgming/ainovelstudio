import { generateCompactionPayload } from "../../lib/agent/contextCompaction";
import type { AgentSessionEvent } from "../../lib/agent/session";
import type { AgentMessage } from "../../lib/agent/types";
import { appendChatEntry } from "../../lib/chat/api";
import { buildMessageEntry, getCompactionCount, nextEntrySeq } from "../../lib/chat/entries";
import { buildSessionPatch } from "../../lib/chat/sessionRuntime";
import type { ChatEntry, ChatSessionSummary, CompactionPayload } from "../../lib/chat/types";
