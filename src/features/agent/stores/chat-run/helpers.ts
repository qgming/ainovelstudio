/**
 * useChatRunStore 的辅助纯函数与 setter 适配器。
 *
...
import type { ChatBootstrap, ChatSessionSummary } from "@features/agent/chat/types";
import {
...
/** useChatRunStore 默认绑定的"全局"虚拟 bookId，未传 bookId 时使用。 */
