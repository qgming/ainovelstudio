...
export const BUILTIN_TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    name: "搜索工作区",
    description:
      "语义检索工作区事实源和正文证据，返回适合 AI 推理的上下文片段；适合了解角色、设定、章节、伏笔、当前状态或数据字段；要精确匹配某个名字/术语用 workspace_grep。",
  },
  {
    id: "workspace_grep",
    name: "精确匹配",
    description:
      "按字面量或正则精确匹配工作区文件内容，返回命中文件、行号和该行文本(可带上下文)；适合找某角色名/术语的全部出现、查错别字、定位改写锚点。",
  },
  {
    id: "web_search",
    name: "网络搜索",
  ...
  },
  {
    ...
    name: "路径操作",
    description:
      "创建文件夹、重命名、迁移路径，或用 action=delete 删除文件/文件夹；只处理结构，不负责正文内容；删除为高风险操作，通常只在用户明确要求时使用。",
  },
  {
    id: "workspace_relation",
    name: "文件关联",
    description:
      "管理工作区文件之间的无向关联;action=list 列出某文件全部关联,create 建关联(带关系标签如\"出场人物\"和可选备注),update 改标签/备注,delete 删关联边;改 relationId 前先 list 取 id。",
  },
  {
    id: "skill_read",
    name: "读取技能",
